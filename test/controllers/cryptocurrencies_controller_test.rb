...
class CryptocurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cryptocurrency" do
    assert_difference('Cryptocurrency.count') do
      post cryptocurrencies_url, params: { cryptocurrency: { code: @cryptocurrency.code, name: @cryptocurrency.name } }
    end
  ...
  test "should update cryptocurrency" do
    patch cryptocurrency_url(@cryptocurrency), params: { cryptocurrency: { code: @cryptocurrency.code, name: @cryptocurrency.name } }
